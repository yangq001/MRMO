...
if(q==7){
  q1=3; q2=4
  sss=c(1,1,1,2,3,4,5)
  a=c(-0.5,-1,-1.5,0,0,0,0) #Y/Z base
  b=c(0,0,0,0,0.55,0,0)       #power scenario 1
  b=c(0,0,0,0.4,0.4,0,0)     #2
  b=c(0.2,0.3,0.4,0,0,0,0)     #3
  b=c(0.2,0.2,0,0.3,0.3,0,0)      #4
  b=c(0.25,0.25,0.25,0.2,0.2,0.2,0.2)    #5
}

#cor
corZ=readRDS("corZ.RDS")
